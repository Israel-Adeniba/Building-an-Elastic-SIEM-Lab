...
<img src="https://imgur.com/jKZhUIs.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<img src="https://imgur.com/LHbVGjb.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  4. Choose a region and deployment size that fits your needs and click on “Create Deployment.”:  <br/>
<img src="https://imgur.com/DfZZ6cS.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  5. Wait for the configuration to complete, once the deployment is ready, click “continue.”: <br/>
<img src="https://imgur.com/CaDnIw3.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<img src="https://imgur.com/kOtMXUX.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
...
<img src="https://imgur.com/OLGet8Q.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  2. Select “Elastic Defend” and click on it to open the integration page: <br/>
<img src="https://imgur.com//lOC6Jxw.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  3. Click on “Add Elastic Defend”: <br/>
<img src="https://imgur.com/lFr5jHR.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  4. Click on “Install Elastic Defend”: <br/>
<img src="https://imgur.com/JVfXCWg.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  5. Follow the instructions provided on the integration page to install the agent on your Kali linux VM.Downloaded file: <br/>
<img src="https://imgur.com/P3pxnxp.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
  6. Paste the copied command into the Kali linux Power shell terminal (command line): <br/>
<img src="https://imgur.com/Z9aEY32.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
...
<img src="https://imgur.com/CTZy7DB.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
...
<img src="https://imgur.com/Lgwm1vk.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
     -The Elastic SIEM website will post a confirmation of Agent enrolment: <br/>
<img src="https://imgur.com/AGkFGcX.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
...
<img src="https://imgur.com/rK9Vy1b.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
 ...
 <img src="https://imgur.com/u6Ko9tr.png" height="80%" width="80%" alt="Building an Elastic SIEM lab"/>
<br />
<br />
